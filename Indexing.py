...
class WebIndex():
    def __init__(self,parent=None):
            ...
            es = Elasticsearch(['http://192.168.43.90:9201','http://192.168.43.90:9202','http://192.168.43.90:9203'],sniff_on_start=True,sniff_on_connection_fail=True,sniffer_timeout=60)
